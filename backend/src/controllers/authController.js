...
const login = async (req, res) => {
  try {
    ...
    res.json({ success: true, user: { id: user.id, name: user.name, email: user.email, role: user.role }, tenant: { id: tenant.id, name: tenant.name, type: tenant.type, emailDomain: tenant.emailDomain } });
  } catch (err) {
