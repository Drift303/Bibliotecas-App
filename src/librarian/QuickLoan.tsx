      ...
      <div className="bg-[#F8F9FB] min-h-screen">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-500 mt-2">
            Gestión y registro de préstamos bibliotecarios
          </p>
        </div>
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <input
                ...
                className="w-full border border-[#E5E7EB] p-3 rounded-xl mb-3 focus:outline-none focus:ring-2 focus:ring-[#3B82F6]"
              />
          ...
          <div className="mt-8 border-t border-[#E5E7EB] pt-6">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  value={form.loanDate}
                  onChange={handleChange}
                  className="w-full border border-[#E5E7EB] p-3 rounded-xl"
                />
              </div>
            ...
            <textarea
              ...
              rows={4}
              className="w-full border border-[#E5E7EB] p-3 rounded-xl mt-4"
            />
          </div>
